...
/**
 * The CalcPi class implements the Task interface and computes the value of to a
 * specified number of decimal places. For this example, the actual algorithm is
 * unimportant. What is important is that the algorithm is computationally
 * expensive, meaning that you would want to have it executed on a capable
 * server.
 */
public class CalcPI implements Task<BigDecimal>, Serializable {

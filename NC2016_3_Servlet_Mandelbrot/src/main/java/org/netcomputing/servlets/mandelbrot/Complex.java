...
public class Complex implements Cloneable, Serializable {
  ...
  **/
  ...
  public Object clone() {
    try {
      ...
      return null;
      // This cannot happen: there would have to be a serious internal error in the Java runtime if this codepath happens!
    } //endtry
  } //end clone()
  ...
  **/
  ...
  public static void madd(Complex a, Complex b) {
    a.re += b.re;
    a.im += b.im;
  }
  ...
  **/
  ...
  public static void mmul(Complex z1, Complex z2) {
    double r= (z1.re * z2.re) - (z1.im * z2.im);
    z1.im= (z1.re * z2.im) + (z1.im * z2.re);
    z1.re= r;
  }

  public static void msqr(Complex z) {
  ...
  **/
  ...
  public String toString() {
    ...
    result.append(format(re));

    if (im < 0.0) { // ...remembering NaN & Infinity
      result.append(" - ").append(format(-im));
